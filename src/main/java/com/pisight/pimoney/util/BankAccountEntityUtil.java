...
public class BankAccountEntityUtil {

	@SuppressWarnings("rawtypes")
	public static void copyToBankAccountEntity(BankAccount account, BankAccountEntity entity) 
		...
		ScriptLogger.writeInfo("copyToBankAccountEntity convert");
	...
	@SuppressWarnings("rawtypes")
	public static void copyToBankAccountEntity(BankAccountHistory account, BankAccountEntity entity) 
			throws ParseException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
	...
	public static BankAccountEntity toBankAccountEntityDC(BankAccount account) throws ParseException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		BankAccountEntity entity = toBankAccountEntity(account);

		List<BankTransaction> txns = null;
		...
		List<BankTransactionEntity> txnEntities = new ArrayList<BankTransactionEntity>();
		ScriptLogger.writeInfo("txns entities size before :: " + txnEntities.size());
		for(BankTransaction txn: txns) {
			BankTransactionEntity txnEntity = BankTransactionEntityUtil.toBankTransactionEntity(txn);
			if(txnEntity != null) {
	...
	@SuppressWarnings("rawtypes")
	public static void copyToBankAccount(BankAccountEntity entity, BankAccount account) 
