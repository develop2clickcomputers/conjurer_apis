 ...
 */
@Entity
@Table(name="holding_asset")
@JsonIgnoreProperties({"createdAt", "updatedAt", "fingerprint","holdingAssetName", "holdingAssetProfit", "holdingAssetProfitPerc", 
	"holdingAssetCustodian", "holdingAssetIssuer", "holdingAssetCommencingDate", "holdingAssetInterestTillMaturity", 
	"holdingAssetOption", "assetCostDate", "closingMethodCode", "versusDate", "srcDstType", "srcDstSymbol", "tradeDateFxRate", 
	"valuationDateFxRate",  "assetOriginalFxRate", "markToMarket", "assetMTM",  "assetWithholdingTax", "exchange", "exchangeFee", 
	"impliedCommission", "commissionPurpose", "assetPledge", "destinationPledge",  "destinationCustodian", "assetDuration",  "recordDate", 
	"strategy", "reclaimAmount", "accrualAccount", "dividendAccrualMethod", "mgmtFeePeriodDate", "recallable", "brokerFirmSymbol", 
	"committedCapital", "contributedCapital", "tradeDate", "settlementDate", "securityType", "destinationCurrency", "assetTicker", 
	"assetCUSIP", "assetSEDOL", "assetQUIK",  "assetRIC",  "fxDenominatorCurrency", "fxNumeratorCurrency", "bloombergTicker", 
	"underBloombergTicker", "underCUSIP", "underISIN", "underRIC", "underSEDOL",  "underTicker", "priceFactor", "basePrice", 
	"accountCurrency", "settlementCurrency", "lastTradeDate", "dividendReInvestIndicator", "optionType", "securityCountryCode",  
	"corpActionsIndicator", "vat",  "investmentObjective",  "bondNature", "account"})
public class HoldingAssetEntity implements Serializable {
	...
	/**
	 * @param holdingAssetFxAccruredInterest the holdingAssetFxAccruedInterest to set
	 */
	public void setHoldingAssetFxAccruedInterest(String holdingAssetFxAccruredInterest) {
		this.holdingAssetFxAccruedInterest = holdingAssetFxAccruredInterest;
	}
