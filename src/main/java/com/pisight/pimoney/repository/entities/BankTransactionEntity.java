...
//@JsonIgnoreProperties({"createdAt", "updatedAt", "transactionHash",  "fingerprint", "account"})
@JsonIgnoreProperties({"account", "categoryObj", "subCategoryObj"})
public class BankTransactionEntity extends TransactionBaseEntity  implements Serializable{

	private static final long serialVersionUID = 1663682363485745973L;
